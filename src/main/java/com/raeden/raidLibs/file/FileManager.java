package com.raeden.raidLibs.file;
...
public class FileManager {
    ...
    public static void createNewFile(String location, String file_name) {
        ...
        if(file.exists()) {
            GeneralUtils.infoLog("A file with that name and type already exists!");
            return;
        }
    ...
    public static void createDirectory(String location, String dir_name) {
        ...
        if(file.isDirectory() && file.exists()) {
            GeneralUtils.infoLog("A directory with that name already exists!");
            return;
        }
    ...
    public static <T> T readJSONFile(File file_name, Class<T> clazz) {
        ...
        try (Reader reader = new FileReader(file_name)) {
            ...
            GeneralUtils.severeLog(" Failed to read " + file_name + "!");
            e.printStackTrace();
            return null;
        }
    }
    ...
    public static <T> void writeToJSONFile(File file_name, Class<T> clazz, boolean flush_close) {
        ...
        try {
            ...
            GeneralUtils.severeLog("Failed to write to " + file_name + "!");
            e.printStackTrace();
